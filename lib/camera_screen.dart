...
import 'package:shreyas_camera_assignment/gallery_screen.dart';
import 'package:shreyas_camera_assignment/video_timer.dart';
        ...
        children: <Widget>[
          ...
          DraggableScrollableSheet(
              ...
              builder: (context,scrollableController){
                print("...${scrollableController.keepScrollOffset}");
                return GalleryScreen(scrollController: scrollableController,);
              }),
        ],
      ),
